    ...
    >
      ...
      <div class="flex justify-between items-center mt-10 font-khmer">
        <div>
          ...
          <div class="text-2xl md:text-5xl mt-4 md:mt-10">ណឹង​</div>
          <div class="text-2xl md:text-5xl mt-2 md:mt-10">កក្កដា</div>
        </div>
        ...
        <div>
          ...
          <div class="text-2xl md:text-5xl mt-4 md:mt-10">សេង​</div>
          <div class="text-2xl md:text-5xl mt-2 md:mt-10">ជាលីញ</div>
        </div>
      </div>
      ...
      <button
        ...
        onclick="window.open('https://maps.app.goo.gl/hL8rpCJ2QUvcYN5H9', '_blank')"
      >
      ...
      <section class="mt-40">
        ...
        >
          ...
          ជ័យមង្គល ក្នុងពិធីភ្ជាប់ពាក្យ របស់យើងខ្ញុំ
        </div>
        <div
        ...
        <div class="text-yellow-500 text-2xl md:text-3xl font-khmer-kh mt-10">
          ដែលនឹងប្រព្រឹត្តទៅ ចាប់ពីម៉ោង 7 ព្រឹក
        </div>
        <div class="text-3xl md:text-5xl mt-4 md:mt-10 font-khmer">
          ថ្ងៃអាទិត្យ​ ទី២៧ ខែមេសា ឆ្នាំ២០២៥
        </div>
        <button
          ...
          onclick="window.open('https://calendar.google.com/calendar/u/0/r/day/2025/4/27')"
        >
      ...
      <section class="mt-40">
        ...
        <div class="flex justify-center gap-2 md:gap-5">
          <div>
            <img
              class="md:w-96 w-60"
              src="/src/assets/photo_2025-04-25_22-24-35.jpg"
              alt=""
            />
          </div>
          <!--
